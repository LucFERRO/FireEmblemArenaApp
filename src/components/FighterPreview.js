...
export default function FighterPreview({ fighterList, fighterPosition, changeFighter, fighter1, fighter2, leftOrRight }) {
    ...
    return (
        <div className={styles.fighterPreview}>
            ...
            <FighterInfo fighter1={fighter1} fighter2={fighter2} leftOrRight={leftOrRight} />
        </div>
    )
}